...
export class ListaVentas extends React.Component {
  state = {
    materia: compras,
    form: {
      id_compra: "",
  ...
  editar = (dato) => {
    ...
    var lista = this.state.materia;
    lista.map((registro) => {
      if (dato.id_compra == registro.id_compra) {
        lista[contador].fecha_compra = dato.fecha_compra;
        lista[contador].proveedor = dato.proveedor;
        lista[contador].articulo = dato.articulo;
        lista[contador].cantidad = dato.cantidad;
        lista[contador].total = dato.total;
      }
      contador++;
    });
          ...
          <Modal isOpen={this.state.modalEditar}>
            ...
            <ModalBody>
              <FormGroup>
                <label>id:</label>
                <input
                  value={this.state.form.id_compra}
              ...
              <FormGroup>
                <label>Fecha:</label>
                <input
                  value={this.state.form.fecha_compra}
